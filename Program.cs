...
namespace Adressbook_Assignments
{
    ...
    class Program
    {
        ...
        static void AddContact()
        {
            do
            {
                ...
                Console.WriteLine("Enter the contacts county.");
                contact1.County = Console.ReadLine();
                ...
                Console.WriteLine("Contacts county: " + contact1.County);
        ...
        static void ListContacts()
        {
            ...
            Console.WriteLine(contact1.County + " ");
